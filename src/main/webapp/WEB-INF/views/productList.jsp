                    ...
                    <div class="modal-body">
                        <form action="/product/add" method="post" accept-charset="utf-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="loai" name="loai" placeholder="Nhập loại" required min="0">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="soLuong" name="soLuong" placeholder="Nhập số lượng" required min="0">
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/product/update" method="post" accept-charset="utf-8">
                            ...
                            <div class="form-group">
                                <label for="loai">Loại</label>
                                <input type="number" class="form-control" id="loai1" name="loai" placeholder="Nhập loại" required min="0">
                            </div>
                            <div class="form-group">
                                <label for="donVi">Đơn vị</label>
                            ...
                            <div class="form-group">
                                <label for="soLuong">Số lượng</label>
                                <input type="number" class="form-control" id="soLuong1" name="soLuong" placeholder="Nhập số lượng" required min="0">
                            </div>
                            <div class="form-group">
                                <label for="gia">Giá</label>
