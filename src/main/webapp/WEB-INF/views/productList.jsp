         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/18600336/products-list">Sản phẩm</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/18600336/products-list">Khách hàng</a>
                    </li>
<!--                    <li class="nav-item dropdown">
                ...
                <form class="form-inline my-2 my-lg-0" action="/18600336/product/search" method="GET">
                ...
                <ul class="nav navbar-nav navbar-logo mx-auto">
                    <li class="nav-item">
                        <button type="button" class="btn btn-outline-danger">Nạp tiền</button>
                    </li>
                </ul>
            </div>
        </nav>
        <div class="container p-3">
            <div class="table-title p-2" >
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="/18600336/product/add" class="btn btn-outline-info"">
                    ...
                    <tbody>
                        <c:forEach var="product" items="${productList}" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <a href="/18600336/product/edit/${product.getMaSP()}" class="btn btn-outline-primary">
