            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="/18600336/customers-list">Khách hàng</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container p-3">
            <div class="table-title p-2" >
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <button class="btn btn-outline-info" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">
